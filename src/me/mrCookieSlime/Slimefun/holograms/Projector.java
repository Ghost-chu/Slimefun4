...
public class Projector {
	...
	public static void openEditor(Player p, final Block projector) {
		ChestMenu menu = new ChestMenu("全息文字设置");
		
		menu.addItem(0, new CustomItem(new ItemStack(Material.NAME_TAG), "&7文字 &e(点击来编辑)", "", "&r" + ChatColor.translateAlternateColorCodes('&', BlockStorage.getLocationInfo(projector.getLocation(), "text"))));
		...
		menu.addItem(1, new CustomItem(new ItemStack(Material.CLOCK), "&7偏移: &e" + DoubleHandler.fixDouble(Double.valueOf(BlockStorage.getLocationInfo(projector.getLocation(), "offset")) + 1.0D), "", "&r左键单击: &7+0.1", "&r右键单击: &7-0.1"));
